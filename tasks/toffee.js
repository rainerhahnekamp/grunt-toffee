/*
 * grunt-toffee
 * https://github.com/rainerh/grunt-toffee
 *
 * Copyright (c) 2014 Rainer Hahnekamp
...
module.exports = function(grunt) {
  ...
  grunt.registerMultiTask('toffee', 'Compiles ToffeeScript files into JavaScript', function() {
  ...
  var compileCoffee = function(code, options, filepath) {
    ...
    try {
      ...
      grunt.fail.warn('ToffeeScript failed to compile.');
    }
  };
